...
$string['mdeditor:edit'] = 'Edit local translation';
$string['mdeditor:export'] = 'Export local translation';
$string['mdeditor:view'] = 'View local translation';
...
$string['pluginname'] = 'Module Description Editor';
